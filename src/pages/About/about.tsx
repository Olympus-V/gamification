        ...
        <div className='container about-page d-flex flex-col'>
            <div className={`section d-flex flex-row align-items-center ${expandedSection === 'team' ? 'expanded' : ''}`}>
                {expandedSection !== 'team' ? (
                    <>
                        <img src='/images/General/team.svg' alt='Team' className='icon' />
                        <div>
                            <h2>Team</h2>
            ...
            <div className='section d-flex flex-row align-items-center'>
                <img src='/images/General/socialMedia.svg' alt='Social Media' className='icon' />
                <div>
                    <h2>Social Media</h2>
            ...
            <div className='section d-flex flex-row align-items-center'>
                <img src='/images/General/dataSafety.svg' alt='Data Safety' className='icon' />
                <div>
                    <h2>Data Safety</h2>
            ...
            <div className='section d-flex flex-row align-items-center'>
                <img src='/images/General/ratings.svg' alt='Ratings and Feedbacks' className='icon' />
                <div>
            ...
            <div className='section d-flex flex-row align-items-center'>
                <img src='/images/General/writeUs.svg' alt='Write Us' className='icon' />
                <div>
                    <h2>Write to us</h2>
            ...
            <div className='section d-flex flex-row align-items-center'>
                <img src='/images/General/joinUs.svg' alt='Join Us' className='icon' />
                <div>
                    <h2>Join us</h2>
